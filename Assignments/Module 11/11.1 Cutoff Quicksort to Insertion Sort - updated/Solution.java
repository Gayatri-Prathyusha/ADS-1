...
/**.
     ...
     */
    public void swap(final Comparable[] array, final int j, final int minimum) {
        Comparable temp = array[j];
        array[j] = array[minimum];
        array[minimum] = temp;
    }
// time complexity of this method is O(N). It iterates through
// the arrayay to print all the objects in array.
...
/**.
    ...
    public void sort(final Comparable[] array1, final int cutOff) {
        sort(array1, 0, array1.length - 1, cutOff);
    }
